    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background to-muted">
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                {/* Header */}
                <div
                    className="bg-primary dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-lg mb-6 sm:mb-8 p-4 sm:p-6 lg:p-8 text-primary-foreground">
                ...
                {error && (
                    <div
                        className="mb-6 p-3 sm:p-4 bg-destructive/10 border border-destructive/20 rounded-lg shadow-sm animate-in slide-in-from-top-2 duration-300">
                ...
                {hasRunningSessions && (
                    <Card
                        className="mb-6 border-2 border-primary/30 bg-gradient-to-r from-primary/5 to-accent/5 shadow-md">
                        ...
                        <span className="font-medium">
                          ...
                          {session.progress
                              ...
                              : 'Starte...'
                                            ...
                                            <div
                                                className="h-2.5 bg-background rounded-full overflow-hidden shadow-inner">
                                                <div

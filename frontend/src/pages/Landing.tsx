  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-blue-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none opacity-40">
        ...
        <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-violet-400/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4 border-emerald-300 text-emerald-700 font-semibold px-4 py-1">
      ...
      <section className="relative py-20 sm:py-32 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4 border-blue-300 text-blue-700 font-semibold px-4 py-1">
                      ...
                      <CardContent className="p-8 relative">
                        <div className="flex items-start gap-6">
                          <div className="relative flex-shrink-0">
                            ...
                            <div className={`relative w-16 h-16 bg-gradient-to-br ${colors.bg} rounded-2xl 
      ...
      <section className="relative py-20 sm:py-32 bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4 border-violet-300 text-violet-700 font-semibold px-4 py-1">
